 ...
 * }
 */
export declare class AnthropicProviderError extends ProviderError {
     ...
     */
    constructor(message: string, code: string, httpStatus?: number, anthropicErrorType?: string, details?: unknown);
}
//# sourceMappingURL=AnthropicProviderError.d.ts.map