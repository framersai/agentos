 ...
 * }
 */
export declare class GeminiProviderError extends ProviderError {
     ...
     */
    readonly geminiErrorStatus?: string;
    /**
     ...
     */
    constructor(message: string, code: string, httpStatus?: number, geminiErrorStatus?: string, details?: unknown);
}
//# sourceMappingURL=GeminiProviderError.d.ts.map