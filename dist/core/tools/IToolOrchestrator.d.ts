...
export interface IToolOrchestrator {
     ...
     */
    initialize(config: ToolOrchestratorConfig | undefined, permissionManager: IToolPermissionManager, toolExecutor: ToolExecutor, initialTools?: ITool[], hitlManager?: IHumanInteractionManager, emergentOptions?: {
     ...
     */
    listDiscoveredTools?(discoveryResult: CapabilityDiscoveryResult, context?: {
        personaId?: string;
        personaCapabilities?: string[];
        userContext?: UserContext;
    }): Promise<ToolDefinitionForLLM[]>;
