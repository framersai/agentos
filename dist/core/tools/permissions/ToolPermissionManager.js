...
export class ToolPermissionManager {
     ...
     */
    async initialize(config, authService, subscriptionService) {
        ...
        if (!config) {
            throw new GMIError('ToolPermissionManagerConfig cannot be null or undefined during initialization.', GMIErrorCode.CONFIGURATION_ERROR, { managerId: this.managerId, detail: 'Configuration object is missing.' });
        }
     ...
     */
    hasRequiredCapabilities(personaCapabilities, toolRequiredCapabilities) {
     ...
     */
    getRequiredFeaturesForTool(toolIdOrName) {
        this.ensureInitialized();
     ...
     */
    async checkToolSubscriptionAccess(userId, toolIdOrName) {
        this.ensureInitialized();
        ...
        try {
            ...
            const missingFeaturesAccumulator = [];
     ...
     */
    async isExecutionAllowed(context) {
        this.ensureInitialized();
...
//# sourceMappingURL=ToolPermissionManager.js.map