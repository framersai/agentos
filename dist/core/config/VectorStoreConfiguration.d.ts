...
export interface LocalFileVectorStoreConfig extends VectorStoreProviderConfig {
    type: 'local_file_vss' | 'lancedb' | 'chromadb_local';
    databasePath: string;
    defaultEmbeddingDimension?: number;
 ...
 */
export type AnyVectorStoreProviderConfig = InMemoryVectorStoreConfig | SqlVectorStoreConfig | LocalFileVectorStoreConfig | PineconeVectorStoreConfig | WeaviateVectorStoreConfig | HnswlibVectorStoreConfig | QdrantVectorStoreConfig | Neo4jVectorStoreConfig | VectorStoreProviderConfig;
/**
