...
export interface ILongTermMemoryRetriever {
    retrieveLongTermMemory(input: LongTermMemoryRetrievalInput): Promise<LongTermMemoryRetrievalResult | null>;
    recordRetrievalFeedback?(input: LongTermMemoryFeedbackInput): Promise<void>;
}
//# sourceMappingURL=ILongTermMemoryRetriever.d.ts.map