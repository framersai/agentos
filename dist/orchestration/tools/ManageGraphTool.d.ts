 ...
 */
export declare class ManageGraphTool implements ITool<ManageGraphInput, ManageGraphOutput> {
    readonly id = "com.framers.orchestration.manage-graph";
    readonly name = "manage_graph";
    readonly displayName = "Manage Graph";
    readonly description = "Add, remove, or reassign agents in the running mission. Only available to supervisor agents. Use to spawn new workers, remove underperforming agents, reassign roles, add tools, or fork execution branches.";
    readonly category = "orchestration";
    readonly hasSideEffects = true;
    readonly requiredPermissions: string[];
    readonly inputSchema: JSONSchemaObject;
    readonly outputSchema: JSONSchemaObject;
    execute(args: ManageGraphInput, _context: ToolExecutionContext): Promise<ToolExecutionResult<ManageGraphOutput>>;
}
//# sourceMappingURL=ManageGraphTool.d.ts.map