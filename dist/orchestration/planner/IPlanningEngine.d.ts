 ...
 */
export type PlanStepStatus = 'pending' | 'ready' | 'executing' | 'awaiting_approval' | 'completed' | 'failed' | 'skipped';
/**
 ...
 */
export type PlanActionType = 'tool_call' | 'reasoning' | 'information_gathering' | 'subgoal' | 'synthesis' | 'validation' | 'human_input' | 'checkpoint';
/**
 ...
 */
export type PlanningStrategy = 'react' | 'plan_and_execute' | 'tree_of_thought' | 'least_to_most' | 'self_consistency' | 'reflexion';
/**
 ...
 */
export type FeedbackType = 'step_failed' | 'unexpected_output' | 'confidence_drop' | 'timeout' | 'resource_exhausted' | 'human_correction' | 'validation_failed';
/**
...
//# sourceMappingURL=IPlanningEngine.d.ts.map