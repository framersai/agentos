...
import type { GraphEvent, MissionEvalScores, MissionGraphPatch, MissionExpansionTrigger } from '../events/GraphEvent.js';
...
export declare const DEFAULT_THRESHOLDS: Readonly<GuardrailThresholds>;
/** Strategy name for provider-to-node assignment. */
export type ProviderStrategyName = 'best' | 'cheapest' | 'balanced' | 'explicit' | 'mixed';
