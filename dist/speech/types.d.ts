import type { AdaptiveVADConfig, VADResult } from '../hearing/AdaptiveVAD.js';
import type { NoiseProfile } from '../hearing/EnvironmentalCalibrator.js';
import type { SilenceDetectorConfig } from '../hearing/SilenceDetector.js';
...
export type SpeechSynthesisOutputFormat = 'mp3' | 'opus' | 'aac' | 'flac' | 'wav' | 'pcm' | (string & {});
...
export type SpeechSessionState = 'idle' | 'wake-listening' | 'listening' | 'capturing' | 'transcribing' | 'responding' | 'playing' | 'interrupted' | 'closed' | 'error';
export type SpeechSessionBoundaryReason = 'speech-end' | 'silence-timeout' | 'manual' | 'provider' | 'wake-word';
