 ...
 * ```
 */
export class MusicGenLocalProvider {
    constructor() {
        /** @inheritdoc */
        this.providerId = 'musicgen-local';
        /** @inheritdoc */
        this.isInitialized = false;
        /** The loaded text-to-audio pipeline instance. */
        this._pipeline = null;
        /** The resolved model ID. */
        this._modelId = 'Xenova/musicgen-small';
    }
    // -------------------------------------------------------------------------
    // Lifecycle
    // -------------------------------------------------------------------------
    ...
    async generateSFX(_request) {
        throw new Error('MusicGen local provider does not support SFX generation. Use AudioGenLocalProvider instead.');
    }
    // -------------------------------------------------------------------------
    // Capability query
    // -------------------------------------------------------------------------
    ...
    async _ensurePipeline() {
        ...
        try {
            ...
            throw new Error('MusicGen local provider requires @huggingface/transformers. '
...
//# sourceMappingURL=MusicGenLocalProvider.js.map