...
export class OpenAIImageProvider {
    ...
    async initialize(config) {
        ...
        this.config = {
            ...
            defaultModelId: typeof config.defaultModelId === 'string' && config.defaultModelId.trim()
                ...
                : undefined,
            organizationId: typeof config.organizationId === 'string' && config.organizationId.trim()
    ...
    async editImage(request) {
        ...
        if (request.mask) {
            formData.append('mask', new Blob([bufferToBlobPart(request.mask)], { type: 'image/png' }), 'mask.png');
        }
...
//# sourceMappingURL=OpenAIImageProvider.js.map