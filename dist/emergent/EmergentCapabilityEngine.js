...
export class EmergentCapabilityEngine {
    ...
    async forge(request, context) {
        ...
        if (request.implementation.mode === 'compose') {
            ...
            if (!this.config.allowSandboxTools) {
                return {
                    success: false,
                    error: 'Sandboxed emergent tools are disabled. Enable allowSandboxTools to permit code-forged tools.',
                };
            }
        ...
        const candidate = {
            ...
            allowlist: request.implementation.mode === 'sandbox' ? request.implementation.allowlist : undefined,
            testResults,
        };
    ...
    async createSelfImprovementTools(deps) {
        ...
        try {
            ...
            try {
                ...
                tools.push(new ManageSkillsTool({
                    config: {
            ...
            try {
                ...
                tools.push(new CreateWorkflowTool({
                    config: {
            ...
            try {
                ...
                tools.push(new SelfEvaluateTool({
                    config: {
    ...
    removeIndexedToolEverywhere(toolId) {
