 ...
 */
export type EntityType = 'person' | 'organization' | 'location' | 'event' | 'concept' | 'fact' | 'skill' | 'preference' | 'memory' | 'goal' | 'task' | 'document' | 'code' | 'custom';
/**
 * Source of knowledge
 */
 ...
 * Relation types
 */
export type RelationType = 'is_a' | 'part_of' | 'related_to' | 'causes' | 'precedes' | 'located_in' | 'created_by' | 'used_for' | 'has_property' | 'knows' | 'prefers' | 'learned' | 'similar_to' | 'opposite_of' | 'custom';
/**
...
//# sourceMappingURL=IKnowledgeGraph.d.ts.map