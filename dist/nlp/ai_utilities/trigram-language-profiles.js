 ...
 */
export function rankTrigrams(counts, maxRank = 300) {
 ...
 */
export function computeDistance(inputRanked, referenceProfile, maxRank = 300) {
 ...
 */
export function distancesToConfidences(distances) {
 ...
 */
export function iso6393To1(code) {
 ...
 */
export function detectLanguageTrigram(text, options) {
...
//# sourceMappingURL=trigram-language-profiles.js.map