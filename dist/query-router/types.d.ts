 ...
 */
import type { SkillRecommendation, ToolRecommendation, ExtensionRecommendation } from '../rag/unified/types.js';
/**
 ...
 */
export declare const STRATEGY_TO_TIER: Record<RetrievalStrategy, QueryTier>;
/**
 ...
 */
export declare const TIER_TO_STRATEGY: Record<QueryTier, RetrievalStrategy>;
/**
 ...
 */
export declare const DEFAULT_STRATEGY_CONFIG: Required<Omit<QueryRouterStrategyConfig, 'forceStrategy' | 'classifierModel'>> & {
    forceStrategy: undefined;
    classifierModel: undefined;
};
export declare const DEFAULT_QUERY_ROUTER_CONFIG: {
    confidenceThreshold: number;
    classifierModel: string;
    classifierProvider: string;
    maxTier: QueryTier;
 ...
 * ```
 */
export type QueryRouterEventUnion = ClassifyStartEvent | ClassifyCompleteEvent | ClassifyErrorEvent | CapabilitiesActivateEvent | RetrieveStartEvent | RetrieveVectorEvent | RetrieveGraphEvent | RetrieveRerankEvent | RetrieveCompleteEvent | RetrieveFallbackEvent | ResearchStartEvent | ResearchPhaseEvent | ResearchCompleteEvent | GenerateStartEvent | GenerateCompleteEvent | RouteCompleteEvent | StrategySelectEvent | DecomposeEvent | GitHubIndexStartEvent | GitHubIndexCompleteEvent | GitHubIndexErrorEvent;
/**
