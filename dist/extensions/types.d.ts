...
import type { WorkflowDescriptorPayload, WorkflowInstance, WorkflowTaskDefinition, WorkflowTaskStatus } from '../orchestration/workflows/WorkflowTypes';
...
import type { SpeechToTextProvider, SpeechVadProvider, TextToSpeechProvider, WakeWordProvider } from '../speech/types';
/**
 ...
 */
export interface ActiveExtensionDescriptor<TPayload = unknown> extends ExtensionDescriptor<TPayload> {
    /**
...
export declare const EXTENSION_KIND_TOOL = "tool";
export declare const EXTENSION_KIND_GUARDRAIL = "guardrail";
export declare const EXTENSION_KIND_RESPONSE_PROCESSOR = "response-processor";
export declare const EXTENSION_KIND_WORKFLOW = "workflow";
export declare const EXTENSION_KIND_WORKFLOW_EXECUTOR = "workflow-executor";
export declare const EXTENSION_KIND_PERSONA = "persona";
export declare const EXTENSION_KIND_PLANNING_STRATEGY = "planning-strategy";
export declare const EXTENSION_KIND_HITL_HANDLER = "hitl-handler";
export declare const EXTENSION_KIND_COMM_CHANNEL = "communication-channel";
export declare const EXTENSION_KIND_MEMORY_PROVIDER = "memory-provider";
export declare const EXTENSION_KIND_STT_PROVIDER = "stt-provider";
export declare const EXTENSION_KIND_TTS_PROVIDER = "tts-provider";
export declare const EXTENSION_KIND_VAD_PROVIDER = "vad-provider";
export declare const EXTENSION_KIND_WAKE_WORD_PROVIDER = "wake-word-provider";
export declare const EXTENSION_KIND_MESSAGING_CHANNEL = "messaging-channel";
export declare const EXTENSION_KIND_HTTP_HANDLER = "http-handler";
export declare const EXTENSION_KIND_PROVENANCE = "provenance";
export type ToolDescriptor = ExtensionDescriptor<ITool> & {
...
export type HttpHandlerPayload = (req: IncomingMessage, res: ServerResponse) => Promise<boolean> | boolean;
...
export type WorkflowExtensionExecutor = (context: WorkflowExtensionExecutionContext) => Promise<WorkflowExtensionExecutionResult> | WorkflowExtensionExecutionResult;
...
export declare const EXTENSION_KIND_STREAMING_STT = "streaming-stt-provider";
export declare const EXTENSION_KIND_STREAMING_TTS = "streaming-tts-provider";
export declare const EXTENSION_KIND_DIARIZATION = "diarization-provider";
export declare const EXTENSION_KIND_ENDPOINT_DETECTOR = "endpoint-detector";
export declare const EXTENSION_KIND_BARGEIN_HANDLER = "bargein-handler";
