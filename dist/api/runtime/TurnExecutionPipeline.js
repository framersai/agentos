...
export class TurnExecutionPipeline {
     ...
     */
    constructor(activeStreamContexts, chunks, dependencies, config, chunkTransformer, telemetry, resolveOrganizationContext) {
     ...
     */
    async prepareTurn(agentOSStreamId, input) {
        // -------------------------------------------------------------------
        ...
        const gmiResult = await withAgentOSSpan('agentos.gmi.get_or_create', async (span) => {
            ...
            return this.dependencies.gmiManager.getOrCreateGMIForSession(input.userId, input.sessionId, selectedPersonaId, input.conversationId, input.options?.preferredModelId, input.options?.preferredProviderId, input.userApiKeys);
        });
        ...
        return {
            ...
            longTermMemoryQueryText: typeof longTermMemoryRetrievalDiagnostics?.queryText === 'string'
                ? longTermMemoryRetrievalDiagnostics.queryText
...
//# sourceMappingURL=TurnExecutionPipeline.js.map