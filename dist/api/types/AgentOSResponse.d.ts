 ...
 */
import { ToolCallRequest, // Ensure this is what IGMI.ts exports, as suggested by your comment
AudioOutputConfig, ImageOutputConfig, UICommand, ReasoningTraceEntry as ReasoningTrace, // Assuming ReasoningTrace in IGMI is ReasoningTraceEntry[]
CostAggregator } from '../../cognitive_substrate/IGMI';
 ...
 */
export declare enum AgentOSResponseChunkType {
 ...
 */
export type AgentOSResponse = AgentOSTextDeltaChunk | AgentOSSystemProgressChunk | AgentOSToolCallRequestChunk | AgentOSToolResultEmissionChunk | AgentOSUICommandChunk | AgentOSFinalResponseChunk | AgentOSErrorChunk | AgentOSMetadataUpdateChunk | AgentOSWorkflowUpdateChunk | AgentOSAgencyUpdateChunk | AgentOSProvenanceEventChunk;
/**
 ...
 */
export type AgentOSActionableToolCallRequestChunk = AgentOSToolCallRequestChunk & {
 ...
 */
export declare function isToolCallRequestChunk(chunk: unknown): chunk is AgentOSToolCallRequestChunk;
/**
 * Runtime type guard for tool-call request chunks that require the host to
 * call `handleToolResult(...)` to continue the turn.
 */
export declare function isActionableToolCallRequestChunk(chunk: unknown): chunk is AgentOSActionableToolCallRequestChunk;
//# sourceMappingURL=AgentOSResponse.d.ts.map