 ...
 */
import type { DescriptionDetail, SceneDescription, VideoAnalysisProgressEvent } from '../media/video/types.js';
 ...
 * ```
 */
export declare function analyzeVideo(opts: AnalyzeVideoOptions): Promise<AnalyzeVideoResult>;
