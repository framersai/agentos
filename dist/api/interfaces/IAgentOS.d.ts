...
import type { WorkflowQueryOptions, WorkflowTaskUpdate } from '../../orchestration/workflows/storage/IWorkflowStore';
...
export interface IAgentOS {
     ...
     */
    handleToolResult(streamId: string, toolCallId: string, toolName: string, toolOutput: any, isSuccess: boolean, errorMessage?: string): AsyncGenerator<AgentOSResponse, void, undefined>;
    /**
     ...
     */
    handleToolResults?(streamId: string, toolResults: AgentOSToolResultInput[]): AsyncGenerator<AgentOSResponse, void, undefined>;
    /**
...
//# sourceMappingURL=IAgentOS.d.ts.map