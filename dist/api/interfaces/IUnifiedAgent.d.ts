...
import { ToolCallRequest, UICommand } from '../../cognitive_substrate/IGMI';
...
export interface IUnifiedAgent {
     ...
     */
    processTurn(userInput: string | null, conversationContext: ConversationContext, currentStreamId: string): Promise<UnifiedAgentOutput>;
    /**
     ...
     */
    handleToolResult(toolCallId: string, toolOutput: any, toolName: string, conversationContext: ConversationContext, currentStreamId: string): Promise<UnifiedAgentOutput>;
    /**
     ...
     */
    handleInternalError?(internalErrorDescription: string, conversationContext: ConversationContext, isFatalForTurn?: boolean, currentStreamId?: string): Promise<UnifiedAgentOutput>;
}
//# sourceMappingURL=IUnifiedAgent.d.ts.map