 ...
 */
export type ProofLevel = 'verifiable' | 'externally-archived' | 'publicly-auditable' | 'publicly-timestamped';
/**
...
export type ProvenanceEventType = 'genesis' | 'message.created' | 'message.revised' | 'message.tombstoned' | 'conversation.created' | 'conversation.archived' | 'conversation.tombstoned' | 'tool.invoked' | 'tool.result' | 'memory.stored' | 'memory.revised' | 'memory.tombstoned' | 'config.changed' | 'human.intervention' | 'anchor.created' | 'guardrail.triggered';
...
export declare class ProvenanceViolationError extends Error {
