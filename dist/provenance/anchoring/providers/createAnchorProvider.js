 ...
 * ```
 */
export function registerAnchorProviderFactory(type, factory) {
 ...
 */
export function createAnchorProvider(target) {
    ...
    if (target.type === 'custom') {
        ...
        console.warn(`[createAnchorProvider] No provider registered for type "${target.type}". ` +
