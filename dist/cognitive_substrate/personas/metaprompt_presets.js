 ...
 */
export const METAPROMPT_FRUSTRATION_RECOVERY = {
 ...
 */
export const METAPROMPT_CONFUSION_CLARIFICATION = {
 ...
 */
export const METAPROMPT_SATISFACTION_REINFORCEMENT = {
 ...
 */
export const METAPROMPT_ERROR_RECOVERY = {
 ...
 */
export const METAPROMPT_ENGAGEMENT_BOOST = {
 ...
 */
export const ALL_METAPROMPT_PRESETS = [
 ...
 * ```
 */
export function mergeMetapromptPresets(personaMetaPrompts = [], includePresets) {
 ...
 */
export function getPresetMetaprompt(id) {
 ...
 */
export function isPresetMetaprompt(id) {
    return ALL_METAPROMPT_PRESETS.some((preset) => preset.id === id);
}
//# sourceMappingURL=metaprompt_presets.js.map