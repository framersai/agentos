 ...
 * @enum {string}
 */
export declare enum GMIPrimeState {
    IDLE = "idle",
 ...
 * @enum {string}
 */
export declare enum GMIInteractionType {
    TEXT = "text",
 ...
 * @enum {string}
 */
export declare enum GMIOutputChunkType {
 ...
 * @enum {string}
 */
export declare enum ReasoningEntryType {
    LIFECYCLE = "LIFECYCLE",
 ...
 * @enum {string}
 */
export type LifecycleAction = 'ALLOW_ACTION' | 'PREVENT_ACTION' | 'DELETE' | 'ARCHIVE' | 'SUMMARIZE_AND_DELETE' | 'SUMMARIZE_AND_ARCHIVE' | 'RETAIN_FOR_DURATION' | 'MARK_AS_CRITICAL' | 'NO_ACTION_TAKEN' | 'ACKNOWLEDGE_NOTIFICATION';
/**
...
export interface IGMI {
    ...
    handleToolResult(toolCallId: string, toolName: string, resultPayload: ToolResultPayload, userId: string, userApiKeys?: Record<string, string>): Promise<GMIOutput>;
    handleToolResults?(toolResults: ToolCallResult[], userId: string, userApiKeys?: Record<string, string>): Promise<GMIOutput>;
