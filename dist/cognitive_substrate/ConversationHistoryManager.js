...
import { GMIInteractionType, } from './IGMI.js';
...
export class ConversationHistoryManager {
     ...
     */
    constructor(maxHistoryLength = DEFAULT_MAX_CONVERSATION_HISTORY_TURNS) {
     ...
     */
    updateWithToolResult(toolCallResult) {
        this.conversationHistory.push({
            role: 'tool',
     ...
     */
    buildForPrompt() {
        return this.conversationHistory.map(msg => this.convertToConversationMessage(msg));
    }
    /**
     ...
     */
    convertToConversationMessage(chatMsg) {
...
//# sourceMappingURL=ConversationHistoryManager.js.map