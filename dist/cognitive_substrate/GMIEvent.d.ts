 ...
 */
export declare enum GMIEventType {
    /**
 ...
 */
export declare function createGMIEvent(eventType: GMIEventType, turnId: string, severity: GMIEventSeverity, metadata?: GMIEventMetadata): GMIEvent;
/**
 ...
 */
export declare function eventMatchesTrigger(eventType: GMIEventType, triggerEventName: string): boolean;
//# sourceMappingURL=GMIEvent.d.ts.map