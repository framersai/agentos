 ...
 */
export type AgentClassConstructor<TExtendsAgentConfig extends AgentConfig = AgentConfig> = new (config: TExtendsAgentConfig, promptEngine: IPromptEngine, llmProvider: IProvider, utilityAI?: IUtilityAI, agentFactory?: IAgentFactory) => IAgent;
/**
...
//# sourceMappingURL=IAgentFactory.d.ts.map