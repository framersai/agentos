 ...
 */
export type AgentMessageType = 'task_delegation' | 'status_update' | 'question' | 'answer' | 'finding' | 'decision' | 'critique' | 'handoff' | 'acknowledgment' | 'error' | 'broadcast' | 'heartbeat';
/**
...
//# sourceMappingURL=IAgentCommunicationBus.d.ts.map