 ...
 */
export type MemoryTypeFilter = 'episodic' | 'semantic' | 'procedural' | 'prospective' | 'relational';
/**
 ...
 * ```
 */
export declare function buildDefaultPlan(strategy: RetrievalStrategy, overrides?: Partial<RetrievalPlan>): RetrievalPlan;
/**
 ...
 * ```
 */
export declare function buildDefaultExecutionPlan(strategy: RetrievalStrategy, overrides?: Partial<ExecutionPlan>): ExecutionPlan;
