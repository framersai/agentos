...
export declare class HnswlibVectorStore implements IVectorStore {
    ...
    private getPath;
    private fnv1a32;
    private deriveFileBase;
    private isMetric;
    private ensurePersistenceReady;
    private writeJsonAtomic;
    private persistManifest;
    private getPersistPaths;
    private markDirty;
    private flushPersistence;
    private persistCollection;
    private loadPersistedCollection;
    private getExistingCollection;
    /**
