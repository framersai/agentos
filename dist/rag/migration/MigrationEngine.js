...
export class MigrationEngine {
     ...
     */
    static async _createSource(config) {
        switch (config.type) {
            case 'sqlite': {
            ...
            default:
                throw new Error(`Unsupported migration source type: ${config.type}`);
        }
    }
    /**
     ...
     * Uses dynamic imports so unused adapters don't bloat the bundle.
     */
    static async _createTarget(config) {
        switch (config.type) {
            case 'sqlite': {
            ...
            default:
                throw new Error(`Unsupported migration target type: ${config.type}`);
        }
    }
}
