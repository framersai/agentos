...
export class SpeechProviderAdapter {
     ...
     * ```
     */
    constructor(provider, defaultMimeType = 'audio/wav') {
        if (!provider) {
            throw new Error('SpeechProviderAdapter: a SpeechToTextProvider instance is required.');
        }
...
//# sourceMappingURL=SpeechProviderAdapter.js.map