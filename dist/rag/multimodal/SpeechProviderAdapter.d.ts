 ...
 * ```
 */
export declare class SpeechProviderAdapter implements ISpeechToTextProvider {
    /**
     ...
     */
    private readonly _defaultMimeType;
    /**
     ...
     * ```
     */
    constructor(provider: SpeechToTextProvider, defaultMimeType?: string);
    /**
...
//# sourceMappingURL=SpeechProviderAdapter.d.ts.map