 ...
 *
 * The `vision/providers/LLMVisionProvider` class fills the same
 ...
 * access it without reaching into `vision/`. The underlying
 ...
 * ```
 */
// Re-export the existing LLMVisionProvider from vision/ so that
// consumers importing from the multimodal module don't need to reach
// into vision/ directly. The underlying class is unchanged.
export { LLMVisionProvider as LLMVisionAdapter, } from '../../vision/providers/LLMVisionProvider.js';
//# sourceMappingURL=LLMVisionAdapter.js.map