...
import type { IVisionProvider, MultimodalIndexerConfig } from './types.js';
 ...
 * ```
 */
export declare function createMultimodalIndexerFromResolver(opts: MultimodalIndexerFromResolverOptions): MultimodalIndexer;
//# sourceMappingURL=createMultimodalIndexerFromResolver.d.ts.map