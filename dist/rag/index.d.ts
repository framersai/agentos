 ...
 * ```
 */
export type { IVectorStore, VectorStoreProviderConfig, VectorDocument, RetrievedVectorDocument, QueryOptions, QueryResult, UpsertOptions, UpsertResult, DeleteOptions, DeleteResult, CreateCollectionOptions, MetadataFilter, MetadataValue, MetadataFieldCondition, MetadataScalarValue, } from '../core/vector-store/IVectorStore.js';
export type { IVectorStoreManager, VectorStoreManagerHealthReport, } from '../core/vector-store/IVectorStoreManager.js';
export type { IEmbeddingManager, EmbeddingRequest, EmbeddingResponse, } from '../core/embeddings/IEmbeddingManager.js';
export type { IRetrievalAugmentor, RagDocumentInput, RagIngestionOptions, RagIngestionResult, RagRetrievalOptions, RagRetrievalResult, RagRetrievedChunk, RagRetrievalDiagnostics, RagMemoryCategory, } from './IRetrievalAugmentor.js';
...
export { HydeRetriever, type HydeConfig, type HydeLlmCaller, type HydeRetrievalResult, type HydeMultiRetrievalResult, DEFAULT_HYDE_CONFIG, resolveHydeConfig, } from './HydeRetriever.js';
...
export type { IGraphRAGEngine, GraphRAGConfig, GraphEntity, GraphRelationship, GraphCommunity, GraphRAGSearchOptions, GlobalSearchResult, LocalSearchResult, } from '../memory/retrieval/graph/graphrag/index.js';
export type { RAGAuditTrail, RAGOperationEntry, RAGSourceAttribution, } from './audit/index.js';
export { RAGAuditCollector, RAGOperationHandle, type RAGAuditCollectorOptions, } from './audit/index.js';
...
export { createMultimodalIndexerFromResolver, type MultimodalIndexerFromResolverOptions, } from './multimodal/index.js';
export type { ContentModality, ImageIndexOptions, ImageIndexResult, AudioIndexOptions, AudioIndexResult, MultimodalSearchOptions, MultimodalSearchResult, IVisionProvider, ISpeechToTextProvider, MultimodalIndexerConfig, } from './multimodal/index.js';
...
export type { BackendType, BackendConfig, MigrationOptions, MigrationResult, IMigrationSource, IMigrationTarget, } from './migration/types.js';
