...
* readme: correct LongMemEval-M paper baseline (was 65.7, actual paper best is 72.0); soften S framing ([51a65a7](https://github.com/framersai/agentos/commit/51a65a7))
* readme: drop range notation, lead with Mastra +1.4 win, drop memory-library mispositioning ([08fab79](https://github.com/framersai/agentos/commit/08fab79))
* chore: bump version to 0.1.192 ([2374475](https://github.com/framersai/agentos/commit/2374475))
* chore: realign package.json with npm latest after orphaned v0.5.x tags ([44cc5f0](https://github.com/framersai/agentos/commit/44cc5f0))
...
* chore(release): 0.2.0 [skip ci] ([b48919d](https://github.com/framersai/agentos/commit/b48919d))
* chore(release): 0.2.0 [skip ci] ([0c3ed89](https://github.com/framersai/agentos/commit/0c3ed89))
* chore(release): 0.2.0 [skip ci] ([8ebe616](https://github.com/framersai/agentos/commit/8ebe616))
* chore(release): 0.2.0 [skip ci] ([a25afa3](https://github.com/framersai/agentos/commit/a25afa3))
* chore(release): 0.2.0 [skip ci] ([729a381](https://github.com/framersai/agentos/commit/729a381))
* chore(release): 0.2.0 [skip ci] ([86647d9](https://github.com/framersai/agentos/commit/86647d9))
* chore(release): 0.2.0 [skip ci] ([66336be](https://github.com/framersai/agentos/commit/66336be))
* chore(release): 0.2.0 [skip ci] ([1db7c03](https://github.com/framersai/agentos/commit/1db7c03))
* chore(release): 0.2.0 [skip ci] ([3ce037d](https://github.com/framersai/agentos/commit/3ce037d))
* chore(release): 0.2.0 [skip ci] ([77957ce](https://github.com/framersai/agentos/commit/77957ce))
...
* Merge branch 'master' of https://github.com/framersai/agentos ([264e19f](https://github.com/framersai/agentos/commit/264e19f))
* Merge branch 'master' of https://github.com/framersai/agentos ([f9f9cae](https://github.com/framersai/agentos/commit/f9f9cae))
* Merge branch 'master' of https://github.com/framersai/agentos ([7f4ee6b](https://github.com/framersai/agentos/commit/7f4ee6b))
...
* docs: add extension auto-pickup + skills auto-discovery summary, license clarification ([22add48](https://github.com/framersai/agentos/commit/22add48))
...
* docs: drop agentos-cli fiction in MEMORY_SCALING + TELEPHONY_PROVIDERS ([2438ff3](https://github.com/framersai/agentos/commit/2438ff3))
* docs: fix channel adapter constructor + mockPrisma stub (post-coderabbit) ([681b7d6](https://github.com/framersai/agentos/commit/681b7d6))
* docs: fix createAgent fiction + stale demo path ([d0d665e](https://github.com/framersai/agentos/commit/d0d665e))
...
* docs: rewrite multi-doc API examples against real exports ([a9945ad](https://github.com/framersai/agentos/commit/a9945ad))
...
* docs(channels): use registerAdapter consistently + add missing register calls ([30ee5c1](https://github.com/framersai/agentos/commit/30ee5c1))
...
* fix(openai): include usage in streaming responses (was always 0 tokens) ([1c9b8a3](https://github.com/framersai/agentos/commit/1c9b8a3))
* fix(openai): use max_completion_tokens for gpt-5 + o-series models ([fb602a1](https://github.com/framersai/agentos/commit/fb602a1))
* fix(openrouter): consumer loop must wait for [DONE] not finish_reason; add usage tests ([7e28324](https://github.com/framersai/agentos/commit/7e28324))
* fix(openrouter): include usage in streaming responses + recognize trailing usage-only chunk ([a699c5c](https://github.com/framersai/agentos/commit/a699c5c))
