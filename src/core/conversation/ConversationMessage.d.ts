 ...
 */
import { ToolCallRequest as GMIToolCallRequest } from '../../cognitive_substrate/IGMI';
 ...
 */
export type ConversationToolCallRequest = GMIToolCallRequest;
/**
...
export declare function createConversationMessage(role: MessageRole, content: ConversationMessage['content'], options?: ConversationMessageOptions): ConversationMessage;
export {};
