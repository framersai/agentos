...
import { RagMemoryCategory } from '../../cognition/rag/IRetrievalAugmentor.js';
import type { MetadataFilter } from '../vector-store/IVectorStore.js';
import type { LifecycleAction } from '../../cognition/substrate/IGMI.js'; // For defaultActionOnTimeout
