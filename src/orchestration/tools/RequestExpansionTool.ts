 ...
 */
export class RequestExpansionTool implements ITool<RequestExpansionInput, RequestExpansionOutput> {
  ...
  readonly description =
    'Request additional agents or capabilities to complete your task. Use when you encounter a need that your current tools cannot fulfill. The mission planner will evaluate your request and may spawn new agents or forge new tools.';
  ...
  readonly inputSchema: JSONSchemaObject = {
    ...
    properties: {
      ...
      urgency: {
        ...
        description:
          'blocking = cannot continue without this, would_improve = quality suffers, nice_to_have = optional enhancement',
      },
    },
