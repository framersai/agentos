...
export const DEFAULT_MECHANISMS_CONFIG: ResolvedMechanismsConfig = {
  reconsolidation: {
    enabled: true,
    driftRate: 0.05,
 ...
 */
export function resolveConfig(partial: CognitiveMechanismsConfig): ResolvedMechanismsConfig {
