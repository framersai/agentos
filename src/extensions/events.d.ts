...
export type ExtensionEventType = 'pack:loaded' | 'pack:failed' | 'descriptor:activated' | 'descriptor:deactivated';
...
export type ExtensionEvent<TPayload = unknown> = ExtensionPackEvent | ExtensionDescriptorEvent<TPayload>;
