 ...
 */
export type AnyVectorStoreProviderConfig = InMemoryVectorStoreConfig | SqlVectorStoreConfig | LocalFileVectorStoreConfig | PineconeVectorStoreConfig | WeaviateVectorStoreConfig | HnswlibVectorStoreConfig | VectorStoreProviderConfig;
/**
