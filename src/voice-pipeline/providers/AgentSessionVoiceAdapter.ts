 ...
 * ```
 */
export class AgentSessionVoiceAdapter implements IVoicePipelineAgentSession {
   ...
   */
  async *sendText(text: string, _metadata: VoiceTurnMetadata): AsyncIterable<string> {
    this.aborted = false;
