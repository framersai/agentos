 ...
 */
export type ChannelPlatform = 'telegram' | 'whatsapp' | 'discord' | 'slack' | 'webchat' | 'signal' | 'imessage' | 'google-chat' | 'teams' | 'matrix' | 'zalo' | 'email' | 'sms' | (string & {});
/**
 ...
 */
export type ChannelCapability = 'text' | 'rich_text' | 'images' | 'video' | 'audio' | 'voice_notes' | 'documents' | 'stickers' | 'reactions' | 'threads' | 'typing_indicator' | 'read_receipts' | 'group_chat' | 'channels' | 'buttons' | 'inline_keyboard' | 'embeds' | 'mentions' | 'editing' | 'deletion' | (string & {});
